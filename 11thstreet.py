...
def get_search_url(query_keyword):
    ...
    base_url = 'https://globalsearch.11st.co.kr/SearchPrdEnAction.tmall?method=getTotalSearchSeller&targetTab=T&isGnb=Y&prdType=&category=&cmd=&pageSize=&lCtgrNo=&mCtgrNo=&sCtgrNo=&dCtgrNo=&fromACK=&semanticFromGNB=&gnbTag=TO&schFrom=&tagetTabNm=T&adUrl=&adKwdTrcNo=&kwd='
...
# https://globalsearch.11st.co.kr/SearchPrdEnAction.tmall?method=getTotalSearchSeller&targetTab=T&isGnb=Y&prdType=&category=&cmd=&pageSize=&lCtgrNo=&mCtgrNo=&sCtgrNo=&dCtgrNo=&fromACK=&semanticFromGNB=&gnbTag=TO&schFrom=&tagetTabNm=T&adUrl=&adKwdTrcNo=&kwd=